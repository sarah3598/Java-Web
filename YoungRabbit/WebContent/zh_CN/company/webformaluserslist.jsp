				...
				<div id="position">
					<p>
						...
						<a href="jsp/login.jsp">用户信息列表</a>&gt;
						 ...
						 <td><input type="button" value="增加用户" onclick="2addUser()"/></td>
					</p>
				</div>
							  ...
							  <tr class="alist00" align="center">
							      ...
							      <td>
							         ${pe.status} 
							           ...
							           <td>
							         <input type="button" value="删除" onclick="auditUser(${pe.userId})" />
							         &nbsp;&nbsp;
							         <input type="button" value="详细" onclick="editUser(${pe.userId})"/>
							      </td>
							  </tr>							
							</c:forEach>
