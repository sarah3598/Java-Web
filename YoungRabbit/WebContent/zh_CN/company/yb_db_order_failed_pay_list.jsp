...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<%=path%>/company/orders_manage?method=order_failed_pay_list"> 支付失败订单 </a></li>
	...
	<script>
		<%String order_list_json = (String) request.getAttribute("order_failed_pay_list");
			if (order_list_json == "") {
				order_list_json = "[]";
			}%>
		...
		function del_order(ORDER_ID){
			if(confirm("确定要删除该订单吗？")){
				...
				var params = ["method=delete_order&OP=2&ORDER_ID=", ORDER_ID].join("")+["&page_size=", page_size].join("")+["&current_page=", current_page].join("");
