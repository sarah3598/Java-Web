				...
				<DIV>
					...
					<P class="idTabs">
						...
						<A id="#nav02" href="jsp/webUserlogin.jsp">||
							Announcements </A>
						<A id="#nav03" href="jsp/sysuser.html">||
							TeamManagement </A>
						<A id="#nav04" href="servlet/webreportorders?method=listWebOrders">||
							SalesSummary </A>
						<A id="#nav08" href="servlet/webreportusers?method=listWebUsers">||
							Account Statement </A>
