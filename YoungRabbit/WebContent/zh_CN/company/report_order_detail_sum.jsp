...
<title>订单统计汇总表</title>
    ...
    function OnReady(id){
		...
		//AF.func("Build","<!--%=basePath%>/filereport/meeting_check.xml");
		 // AF.func("SetSource", "<!--%=basePath%>filereport/center6.xml");
		 AF.func("SetSource", "<%=basePath%>supcan/reportdata/datacenter.xml");
		 //AF.func("SetSource", "<!--%=basePath%>supcan/report/center6.xml");
		AF.func("Build","<%=basePath%>filereport/order_detail_sum.xml");
		 AF.func("calc", "");
...
<table id="dataform"  class="table_d">
  ...
  <div id="divtable" region="center"  title="订单分类统计汇总表" class="datagrid-wrap panel-body" style="background:#fafafa;overflow:hidden">
