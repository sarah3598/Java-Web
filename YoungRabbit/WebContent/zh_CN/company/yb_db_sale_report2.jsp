...
<%@include file="yb_db_left_nav.jsp"%>
	<div class="container">
		<div id="list" class="table-responsive">
			...
			<h2><button type='button' style='margin-right:20px;' class='btn btn-sm btn-success' onclick='goback();'>返回</button><%=GROUP_NAME%> 销售报表</h2>
...
//			test2.innerHTML = tplt2(JSON.parse(arr));
		...
		function goback(){
			window.location.href="<%=path%>/company/team_manage?method=team_list";
		}
