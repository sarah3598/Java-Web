					...
					<table cellspacing="0" cellpadding="0" width="130%">
						<tbody>
							<tr>
								...
								<th style="text-align: left; padding-left: 15px;" width="200px">
									订单号
								</th>
								<th width="300px">
									客户姓名
							  ...
							  <tr class="alist00" align="center"  rowspan="6" >
							      ...
							      <td>
							       ...
							       <td>
									...
									<!-- td width="159" rowspan="3" bordercolor="1">
										<img src="${pe.goodId}" width="120px;" height="100px;" />
									</td-->
									<td>
							         ${ pe.goodId }
							      </td>
							      ...
							      <td width="159" rowspan="3" bordercolor="1">
										<img src="img/${pe.marketPrice}.jpg" width="60px;" height="50px;" />
									</td>
							      ...
							      <td>
							         <input type="button" value="处理" onclick="deleteEnroll(${pe.orderId})" />
							         &nbsp;&nbsp;
							         <input type="button" value="订单明细" onclick="showEnroll(${pe.orderId})"/>
							      </td>
							  </tr>							
							</c:forEach>
						</tbody>
