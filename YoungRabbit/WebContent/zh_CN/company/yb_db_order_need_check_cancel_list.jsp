...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<%=path%>/company/orders_manage?method=order_need_check_cancel_list"> 待处理已取消订单 </a></li>
				</ul>
				<!--产品管理二级菜单导航  结束-->
				<!--订单列表  -->
	...
	<script>
		<%String order_list_json = (String) request.getAttribute("order_need_check_cancel_list");
			if (order_list_json == "") {
				order_list_json = "[]";
			}%>
		...
		function del_order(ORDER_ID){
			if(confirm("确定要删除该订单吗？")){
				...
				var params = ["method=delete_order&OP=4&ORDER_ID=", ORDER_ID].join("")+["&page_size=", page_size].join("")+["&current_page=", current_page].join("");
