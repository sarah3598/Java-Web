	...
	<section id="register" class="white-bg padding-top-bottom">
		<div class="container">
			<div class="smalldiv">
				...
				<p class="text-center">
					还没有账户&nbsp;<a href="<%=path%>/zh_CN/customer/yb_register_step_1.jsp" title="注册">马上注册</a>
				</p>
				<form id="form" method="post">
					<div class="form-horizontal">
						<span id="hidden_token" style="display: none;"></span> <input type="hidden" id="token" name="token" value="<%=token%>">
						<div class="form-group">
							<div class="col-md-12">
								<input class="form-control largcontrol" id="EMAIL" name="EMAIL" placeholder="Email" type="text"> <span class="text-danger" style="display: none;">电子邮箱格式有误。</span>
							</div>
						</div>

						<div class="form-group">
							<div class="col-md-12">
								<input class="form-control largcontrol" id="PWD" name="PWD" placeholder="Password" value="" type="password"> <span class="text-danger" style="display: none;">密码由6～20个字母、数字、下划线组成。</span>
							</div>
						</div>
						
						<div class="form-group text-center">
							<input value="登录" class="btn btn-qubico" onclick="login();">
						</div>
						<div id="emsg_id"></div>
					</div>
				</form>
