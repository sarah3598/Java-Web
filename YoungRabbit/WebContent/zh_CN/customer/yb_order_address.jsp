...
<body data-spy="scroll" data-target="#main-nav" data-offset="400">
						...
						{{#each this}}
							...
							<div class="card-footer clearfix">
								...
								<label>
									...
									<span class="currency">{{DISCOUNT_MONEY}}</span> 
									<input type="hidden" id="DISCOUNT_MONEY" name="DISCOUNT_MONEY" value="0" disabled>
								</label>
								</div>
							</div>
							<div class="card-footer clearfix">
								...
								<label>
									...
									<input type="hidden" id="ORDER_TOTAL_MONEY" name="ORDER_TOTAL_MONEY" value="" class="form-control">
								</label>
								</div>
							</div>
						{{/each}}
	...
	<%String product_detail_json = (String) request.getAttribute("product_detail");
		...
		function verify_buy_num() {
			...
			var oN = document.getElementById('BUY_NUM');
			var oM=document.getElementById('AMOUNT_MONEY');
			
			var oS=document.getElementById('SHIPPING_PRICE');
			var oD=document.getElementById('DISCOUNT_MONEY');
			var oT=document.getElementById('TOTAL_CHARGE');
