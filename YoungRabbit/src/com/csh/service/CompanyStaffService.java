...
public class CompanyStaffService {
	...
	// by lizhenyu
	public static ResultSet getStaffListRs(String sql, Object[] param) {
	...
	public static String getGradeRuleListRs(int startRow, int endRow, String sql, Object[] param) {
	...
	// by xiaopan
	public static int getStaffListRows(String rowContSql, Object[] param) {
