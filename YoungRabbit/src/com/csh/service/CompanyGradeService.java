...
public class CompanyGradeService {
	...
	// by xiaopan
	public static int getGradeRuleListRows(String rowContSql, Object[] param) {
		int rows = BaseDao.getRowCount(rowContSql, param);
		return rows;
	}

	// by xiaopan
	public static ResultSet doGradeRuleOperate(String sql, Object[] param) {
	...
	// by xiaopan
	public static ResultSet getGradeRuleListRs(int startRow, int endRow, String sql, Object[] param) {
	...
	// by xiaopan
	public static ResultSet getGradeRecordListRs(int startRow, int endRow, String sql, Object[] param) {
	...
	// by xiaopan
	public static int getGradeRecordListRows(String rowContSql, Object[] param) {
		int rows = BaseDao.getRowCount(rowContSql, param);
		return rows;
	}
