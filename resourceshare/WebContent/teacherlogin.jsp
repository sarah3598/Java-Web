...
<main class="col-sm-4 col-sm-offset-4">
	<form class="form-horizontal" role="form" action="TeacherLogin.do" method="post" name="form1">
	<div>教师登录</div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="teacherPhone" name="teacherPhone" placeholder="请输入手机号..." value="<%=userName %>">
	    </div>
	  </div>
	  <div class="form-group">
	    <label for="password" class="col-sm-3 control-label">密码</label>
	    <div class="col-sm-8">
	      <input type="password" class="form-control" id="teacherPwd" name="teacherPwd" placeholder="请输入密码..." value="<%=userPwd %>">
	    </div>
	  </div>
