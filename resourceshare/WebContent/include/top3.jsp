  ...
  <body>
		<div class="top" id="top">
	      ...
	      <ul class="nav navbar-nav" id="navBar">
	        <li class="active" id="nav-index"><a href="index.jsp">首页</a></li>
	      ...
	      <ul class="nav navbar-nav navbar-right">
	          <li><a href="selfupdate.jsp">${sessionScope.teacher.mobile }</a></li>
	          <li><a href="UserIndexServlet.do?op=quit">退出</a></li>
