...
<main class="col-sm-4 col-sm-offset-4">
	<form class="form-horizontal" role="form" action="UserLogin.do" method="post" name="form1">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-8">
	      <input type="password" class="form-control" id="password" name="password" placeholder="请输入密码..." value="<%=userPwd %>">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-5 col-xs-7 exist">
	    	没有账号，前去<a href="register.jsp">注册</a>
	    </div>
	  </div>
	</form>        
</main>
